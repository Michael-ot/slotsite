      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen bg-cover bg-center">
        ...
        >
          ...
          <div className="bg-transparent px-4 py-2">
            ...
            <p className="text-center text-[19px] text-white mt-[20px] max-[414px]:text-[15px]">
              Buy More Credits
            </p>

            <button
              type="submit"
              className="block bg-[#15803D] px-[40px] py-[5px] text-[20px] rounded-full mx-auto text-white font-semibold uppercase mt-[7px] max-[414px]:text-[17px]"
